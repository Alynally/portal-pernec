...
import NavMenuVerTh from "./NavMenuVerTh.vue";
// import PernecLogo from "@/assets/img/logo/Pernecnew.svg";
import PernecLogo2 from "@/assets/img/logo/logopernec.svg";
...
onMounted(() => {
    const handleResize = () => {
        isSmall.value = window.innerWidth <= 1199;
    };
                            ...
                            <div
                                ...
                                <div class="tp-header-3-logo">
                                    <router-link to="/" style="display: flex; justify-content: space-between;">
                                        <img :src="PernecLogo2" alt="image-title-here" style="max-width: 100%;" />
                        ...
                        <div class="col-xl-2 col-6">
                            <div class="tp-header-3-right ">
                                <div class="tp-header-3-main-right d-flex align-items-center justify-content-end">
                                    <div v-if="isSmall" class="tp-header-3-hamburger-btn offcanvas-open-btn"
