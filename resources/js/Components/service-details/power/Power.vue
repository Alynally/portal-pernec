...
import power from "@/assets/img/services/service-details/power.jpg";
import RightSymble from "@/svg/RightSymble.vue";
import energy from "@/assets/img/services/service-details/energy.png"
import smartmeter from "@/assets/img/services/service-details/smartmeter.png"
import iot from "@/assets/img/services/service-details/iot.png"
...
const service_details_content = {
  ...
  description: "Explore how we're at the forefront of ushering utilities into the digital age, revolutionizing operations and unlocking immense value for sustained growth. Our comprehensive suite of Power and Utilities solutions is meticulously crafted to address the evolving needs of the industry, encompassing a spectrum of offerings tailored to drive efficiency and innovation.",
  description_2: "From harnessing Renewable Energy sources to implementing cutting-edge Smart Metering technologies and deploying advanced Smart Infrastructure and Systems, we empower utilities companies to optimize their operations and embrace the future with confidence. With our tailored solutions and unwavering commitment to excellence, we're paving the way for a more sustainable and digitally-enabled utilities landscape, ensuring our clients remain at the forefront of industry innovation.",
}
const { service_details_tab, title, description, description_2 } = service_details_content

const business_data = reactive([
{
    id: 1, img: iot, title: "Smart Infra and System", sm_des: [
      "Smart lighting with integrated IT services",
      "IOT sensors, controllers and platforms"
    ]
  },
  {
    id: 2, img: smartmeter, title: "Smart Meter", sm_des: [
      "Smart electric meters",
      "Smart water meters"
    ]
  },
  {
    id: 3, img: energy, title: "Renewable Energy", sm_des: [
      "Energy Storage Solution",
      "Next Generation Gen-Set",
      "Efficient Solar Panel and Wind Turbine"
    ]
  }
])
              ...
              <div class="tp-service-widget-tab">
                <ul>
                  <li v-for="(item, i) in service_details_tab" :key="i"  v-motion-slide-visible-left>
                    <router-link :class="i === 5 ? 'active' : ''" :to="item.link">
                      {{ item.service }}
        ...
        <div class="col-lg-8">
          <div class="tp-service-details-wrapper">
            <div class="tp-service-details-thumb">
              <img :src="power" alt="image-title-here" v-motion-pop-visible>
            </div>
