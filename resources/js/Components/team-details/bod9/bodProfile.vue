...
import team_member from "@/assets/img/team/details/Hideharu.png";
...
const team_details_contact = {
  ...
  description: "Hideharu Suzuki, appointed to the Board on 10 October 2019, serves as a Director of the Strategy Group within the Global Strategy Department of NEC Corporation (Japan). His career with NEC began in 2003, where he started in the Japan Mobile Network Solution Division, showcasing his dedication and expertise in the telecommunications sector. A graduate of Keio University, Japan with a Bachelor of Economics, Suzuki's role in the Global Business Unit underscores his strategic contributions to NEC's global operations and business strategy.",
