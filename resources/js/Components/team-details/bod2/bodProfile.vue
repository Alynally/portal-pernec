...
import team_member from "@/assets/img/team/details/Hizam.png";
...
const team_details_contact = {
  ...
  description: "Hizam Shah Azaime, currently serving as the Head of Global Fund Investments, Private Markets at Permodalan Nasional Berhad (PNB), brings a wealth of expertise to the board since his appointment on 1 June 2021. Armed with a Master of Engineering in Mechanical Engineering from the University of Bath, United Kingdom, he embarked on his career at PNB, showcasing his versatility across International Fund Management, Private Investment, and now Global Fund Investment roles. His journey within PNB underscores his dedication and depth of experience in various facets of investment management",
